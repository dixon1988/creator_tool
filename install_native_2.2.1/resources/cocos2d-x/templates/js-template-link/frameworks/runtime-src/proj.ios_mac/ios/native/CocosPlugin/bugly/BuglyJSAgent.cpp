...
void BuglyJSAgent::reportJSException(const char *message, const char *traceback) {
    CrashReport::reportException(CATEGORY_JS_EXCEPTION,  "JSException", message, traceback);
}
